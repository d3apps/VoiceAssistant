...
public class Weather {
    ...
    public interface WeatherService {
        @GET("/v1/current.json?key=c5c94cfe1555404985e231323192304")
    ...
    public static void get(String city, final Consumer<String> callback) {
        ...
        call.enqueue(new Callback<ApiResult>() {
            ...
            public void onResponse(Call<ApiResult> call, Response<ApiResult> response) {
                ...
                String result = "Там сейчас " + apiResult.current.condition.text + ", где то "
                        + apiResult.current.temperature.intValue() + " градусов.";
